...
<Callout type="info">
  This page is recipes, not components. Everything below is built from [`Dropzone`](/docs/uploads/dropzone) and [`FileCard`](/docs/display/file-card) — nothing new to install.
</Callout>
