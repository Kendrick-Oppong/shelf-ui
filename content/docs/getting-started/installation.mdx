...
Shelf UI is in the shadcn directory. No extra config needed — add components directly:
...
Shelf UI components support enhanced, physics-based micro-interactions via Framer Motion. By default, components install using zero-runtime CSS transitions.

To opt into Framer Motion for advanced drag-interactions and springs, append the `--motion` flag to your install command:
...
```
  ...
  <Tab value="pnpm">
```bash title="terminal"
pnpm dlx shadcn@latest add @shelf-ui/dropzone --motion
```
  </Tab>
  <Tab value="yarn">
```bash title="terminal"
yarn dlx shadcn@latest add @shelf-ui/dropzone --motion
```
  </Tab>
  <Tab value="bun">
```bash title="terminal"
bunx shadcn@latest add @shelf-ui/dropzone --motion
```
  </Tab>
</Tabs>
...
<Tabs groupId="pkg" items={["npm", "pnpm", "yarn", "bun"]} persist>
  <Tab value="npm">
```bash title="terminal"
npx shadcn@latest add https://shelfui.dev/r/dropzone.json
```
  </Tab>
  <Tab value="pnpm">
```bash title="terminal"
pnpm dlx shadcn@latest add https://shelfui.dev/r/dropzone.json
```
  </Tab>
  <Tab value="yarn">
```bash title="terminal"
yarn dlx shadcn@latest add https://shelfui.dev/r/dropzone.json
```
  </Tab>
  <Tab value="bun">
```bash title="terminal"
bunx shadcn@latest add https://shelfui.dev/r/dropzone.json
```
  </Tab>
</Tabs>
