...
Once published, add the following to your AI assistant's MCP config. No API key required — the server reads from the public Shelf UI registry at `https://shelfui.dev/r`.
...
| --------------- | --------------------------------------------------- |
| npm             | `npx shadcn@latest add https://shelfui.dev/r/[name].json`   |
| pnpm            | `pnpm dlx shadcn@latest add https://shelfui.dev/r/[name].json` |
| yarn            | `yarn dlx shadcn@latest add https://shelfui.dev/r/[name].json` |
| bun             | `bunx shadcn@latest add https://shelfui.dev/r/[name].json`  |
