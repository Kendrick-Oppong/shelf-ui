...
<Callout type="tip">
  Use the [shadcn theme generator](https://ui.shadcn.com/themes) or [Tweakcn](https://tweakcn.com) to produce a compatible token set — then paste the output into your `globals.css`. All Shelf UI components will pick it up automatically.
</Callout>
